...
This document describes the Shapes data schema that exist so far, sketches some schema that don't yet exist, and describes the workflow for populating and using the data.
